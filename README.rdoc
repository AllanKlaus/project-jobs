#Project Find Jobs
I'm learning Tuby on Rails and this is my first project.
...
2- Locals var in render isn't passing on companies_path, company_path, categories_path, category_path
