...
1- Tests to check validation on forms
2- Expire jobs that not was updated in 90 days
3- Search on Jobs
4- When user is logger show option to edit jobs, categories and companies when it is showing. Ex.: job_path(job)
